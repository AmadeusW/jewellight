...
Mode modes[NUM_MODES] = {
  {{0, 1, 1, 1, 2, 2, 2}, { // Fire fighter
    {0xff5511, 0xff1a00, 0x000000}, 
    {0xff5511, 0x000000, 0x000000}, 
    {0xff5511, 0xff1a00, 0x000000}, 
    {0xff5511, 0x000000, 0x000000},
    {0xff5511, 0x000000, 0xff1a00}, 
    {0xff5511, 0x000000, 0x000000}, 
    {0xff5511, 0x000000, 0xff1a00}, 
    {0xff5511, 0x000000, 0x000000}
    }, 2},
  ...
  {{0, 0, 1, 1, 0, 2, 2}, { // Police car
    ...
    {0x2222ff, 0x0000ff, 0x000000}, 
    {0xff2222, 0x000000, 0xff0000},
    {0x0000ff, 0xff0000, 0x000000}, 
    {0xff0000, 0x000000, 0x0000ff}, 
    {0x0000ff, 0x0000ff, 0x000000}, 
    {0xff0000, 0x000000, 0xff0000}
    }, 1},
  {{0, 1, 2, 1, 2, 1, 2}, { // Ambulance
    {0xff8833, 0xff0000, 0x000000}, 
    {0x000000, 0x000000, 0xff0000}, 
    {0xff8833, 0xff0000, 0x000000}, 
    {0xff8833, 0x000000, 0xff0000},
    {0x000000, 0xff0000, 0x000000},
    {0x000000, 0x000000, 0xff0000},
    {0xff8833, 0xff0000, 0x000000},
    {0x000000, 0x000000, 0xff0000},
